...
export const getFilteredMidParentalHeightData = (
    ...
    if (midParentalHeightData.mid_parental_height_centile && midParentalHeightData.mid_parental_height_centile_data.length > 0){
        ...
        midParentalHeightData.mid_parental_height_centile_data.map((referenceData: UKWHOReferences | CDCReferences, index) => {
            ...
            if (reference === "uk-who" && isUKWHOReferences(referenceData)) {
                ...
                lowercentiles = midParentalHeightData.mid_parental_height_lower_centile_data[index].fenton || midParentalHeightData.mid_parental_height_lower_centile_data[index].cdc_infant || midParentalHeightData.mid_parental_height_lower_centile_data[index].cdc_child;
                uppercentiles = midParentalHeightData.mid_parental_height_upper_centile_data[index].fenton || midParentalHeightData.mid_parental_height_upper_centile_data[index].cdc_infant || midParentalHeightData.mid_parental_height_upper_centile_data[index].cdc_child;
            } else {
